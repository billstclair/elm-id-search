...
var author$project$Main$HandleUrlChange = function (a) {
	return {$: 'HandleUrlChange', a: a};
};
var author$project$Main$HandleUrlRequest = function (a) {
	return {$: 'HandleUrlRequest', a: a};
};
...
var author$project$Main$mainPage = function (model) {
	return mdgriffith$elm_ui$Element$text(model.text);
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_Nil,
				author$project$Main$mainPage(model))
			]),
		title: 'billstclair/elm-id-search Example'
	};
};
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlChange: author$project$Main$HandleUrlChange,
		onUrlRequest: author$project$Main$HandleUrlRequest,
